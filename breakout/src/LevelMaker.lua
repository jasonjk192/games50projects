...
no_of_locked_bricks = 0

LevelMaker = Class{}

function LevelMaker.getNoOfLockedBricks()
    return no_of_locked_bricks
end
--[[
...
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if x==(numCols+1)/2 and lockedbrick then
                b.locked=true
                b.color=1
                b.tier=0
                no_of_locked_bricks = no_of_locked_bricks+1
            end
